...
후속 정책 안내(2026-09-22): 아래 면접 배분은 감사 당시 이력이다. [공통 0002](../shared/decisions/0002-local-policy-baseline.md)에 따라 현행 정상 9턴 배분은 기술/도메인/HR 6/2/1이며, 포트폴리오 상한 20MB와 공고 재사용 7일도 함께 채택됐다.
