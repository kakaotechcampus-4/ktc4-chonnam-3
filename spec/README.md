...
| --- | --- | --- |
| frontend/docs/api-spec.md, frontend/src/types/api.ts | spec/shared/contracts/ | fetch API는 OpenAPI, 로그인·콜백 등 브라우저 이동은 기존 FE API 문서 유지 |
| backend/docs/api-spec.md, error-reasons.md | spec/shared/contracts/ | 인증 계약은 Accepted 결정과 위 원본을 따르며, 나머지 상충 항목은 migration.md에서 추적 |
